...
parser.add_argument('--adjdata',type=str,default='data/sensor_graph/adj_EMS.csv',help='adj data path')
...
parser.add_argument('--num_nodes',type=int,default=77,help='number of nodes')
