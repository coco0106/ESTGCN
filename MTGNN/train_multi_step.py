...
parser.add_argument('--data',type=str,default='data/EMS',help='data path')

parser.add_argument('--adj_data', type=str,default='data/sensor_graph/adj_EMS.csv',help='adj data path')
...
parser.add_argument('--num_nodes',type=int,default=145,help='number of nodes/variables')
